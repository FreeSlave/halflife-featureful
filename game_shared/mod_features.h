...
#define FEATURE_NIGHTVISION_WHITE_HUD 1 // draw HUD in white when NVG is on
#define FEATURE_OPFOR_NIGHTVISION_DLIGHT (1 && FEATURE_OPFOR_NIGHTVISION) // whether Opfor NVG uses own dlight instead of EF_BRIGHTLIGHT
