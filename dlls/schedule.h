...
typedef enum 
{
		...
		TASK_WALK_TO_SCRIPT_RADIUS,
		TASK_RUN_TO_SCRIPT_RADIUS,
		TASK_FACE_SCHEDULED,
		TASK_REGENERATION,
		TASK_PLAY_SEQUENCE_OR_IDLE,
		TASK_PLAY_SEQUENCE_OR_COMPLETE,
		TASK_PLAY_RELOAD,
...
#define BUILDROUTE_NO_TRIDEPTH ( 1 << 3 )
