...
public:
	...
	float GetScreenSafeArea();

	template<typename T> void ClampToScreenWidthSafeArea(T *x, T *width);
	template<typename T> void ClampToScreenHeightSafeArea(T *y, T *height);

	int ScreenSafeAreaBounds(int value);
...
private:
	...
	// TODO: Decouple engine hooks from new implementations and members (grouped by what they do, like sprite hooks)
	// TODO: This is basically to avoid writing getters
public:
