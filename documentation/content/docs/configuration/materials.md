...
```json
{
    "materials": {
        ...
        "W": {
            "hit": {
                "impact_particle_color": [150, 84, 30]
            }
        }
    },
...
* `wallpuff_color` - the default [wallpuff]({{< ref "visual-effects/#wallpuffs" >}}) [color]({{< ref "json/#color" >}}).
...
* `wallpuff_color` - the custom color of the [wallpuff]({{< ref "visual-effects/#wallpuffs" >}}) produced.
* `impact_particle_color` - the color of [impact particles]({{< ref "visual-effects/#wall-impact-particles" >}}). Same as top-level property, but for a certain material.
