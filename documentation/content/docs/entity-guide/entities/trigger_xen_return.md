...
When touched by a player, `trigger_xen_return` displaces player to the [info_displacer_earth_target]({{< ref info_displacer_earth_target >}}) point and sets the player's gravity to normal value.
...
* **XenReturn.Teleport** - teleport sound. Played on the player.
